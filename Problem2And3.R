...
#Marks a line to show that there are a lot of measurements that are bigger than 11, then are smaller

library(ggplot2)

ggplot(galaxies, aes(x = name, y = m_b)) +
  geom_point() +
  geom_hline(yintercept = -11, color = "blue", linetype = "dashed")
